var Module = (function () {
  ...
  return function (Module) {
      ...
      Instance: function (module, info) {
        ...
        var exports = (function instantiate(asmLibraryArg, wasmMemory, wasmTable) {
          function asmFunc(global, env, buffer) {
            ...
            return {
              __wasm_call_ctors: $1,
              crypto_sign_ed25519_ref10_ge_scalarmult_base: $61,
              curve25519_sign: $3,
              curve25519_verify: $4,
              sph_sha512_init: $70,
              curve25519_donna: $7,
    ...
    var _crypto_sign_ed25519_ref10_ge_scalarmult_base = (Module[
      ...
      return (_crypto_sign_ed25519_ref10_ge_scalarmult_base = Module['_crypto_sign_ed25519_ref10_ge_scalarmult_base'] =
        Module['asm']['crypto_sign_ed25519_ref10_ge_scalarmult_base']).apply(null, arguments)
    })
